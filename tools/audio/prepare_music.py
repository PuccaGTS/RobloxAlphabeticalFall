...
# Ключи из src/shared/Config/Stages.luau (THEMES). Тем три, ступеней алфавита
# одиннадцать: темы идут по кругу, меняясь при переходе на новую ступень.
# Исходники по-прежнему называются «Остров1_1.wav» и т.д. — это имена файлов
# от музыканта, переименовывать их незачем, ключ задаётся здесь.
ISLAND_KEYS = {
    1: ("mus_theme_1", "Тема 1"),
    2: ("mus_theme_2", "Тема 2"),
    3: ("mus_theme_3", "Тема 3"),
}
