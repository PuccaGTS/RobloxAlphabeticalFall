...
# Упираются обычно короткие реплики с резким началом: K-взвешивание считает их
# тихими, а пик у них высокий. Поднимать допуск смысла нет — на 2 дБ разброс
# уже около 0.2 дБ, а дальше лимитер лезет в лишние файлы и портит их.
MAX_LIMIT_DB = 2.0
