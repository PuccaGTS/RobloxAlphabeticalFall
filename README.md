...
поднимается по алфавитной лестнице. Между заданиями — полоса препятствий.
...
**Ближайшее и самое важное: записать 84 реплики по списку
[docs/VO-SCRIPT.md](docs/VO-SCRIPT.md)** — 63 по алфавиту и 21 по счёту. Ребёнок
4–7 лет не читает: без озвучки он просто не понимает, чего от него хотят.
Это единственное, что отделяет проект от проверки на живом ребёнке.
...
| [19-OBSTACLES](docs/19-OBSTACLES.md) | Полоса препятствий |
